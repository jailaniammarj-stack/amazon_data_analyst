...
* **Data Cleaning & Preprocessing:** Python & Microsoft Excel
...
3. **Donut Chart:** Highlights customer sentiment percentages (Satisfied, Neutral, Low) based on review counts.
4. **Trend Line/Bar Chart:** Shows the distribution of total reviews across different rating points (from 1 to 5 stars).
